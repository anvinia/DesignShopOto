<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="XeOTo.aspx.cs" Inherits="DoAn.XeOTo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel2" runat="server" Height="999px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DOANConnectionString %>" DeleteCommand="DELETE FROM [OTO] WHERE [STT] = @STT" InsertCommand="INSERT INTO [OTO] ([STT], [TENXE], [NOISANXUAT], [GIA], [SL], [ANH]) VALUES (@STT, @TENXE, @NOISANXUAT, @GIA, @SL, @ANH)" SelectCommand="SELECT * FROM [OTO]" UpdateCommand="UPDATE [OTO] SET [TENXE] = @TENXE, [NOISANXUAT] = @NOISANXUAT, [GIA] = @GIA, [SL] = @SL, [ANH] = @ANH WHERE [STT] = @STT">
            <DeleteParameters>
